import { CLIPPED_TAB_FOCUS, CLIP_ITEM_RESET, CLIP_NEWS_ITEM, GET_NEWS_LIST_FAILURE, GET_NEWS_LIST_REQUEST, GET_NEWS_LIST_SUCCESS } from "../action/news";

const defaultNewsReducer = {
  favoriteNews: [],
  newsList: [],
  loading: false,
  isInitFocusTabOne: false,
};
